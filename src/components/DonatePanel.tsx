...
export default function DonatePanel({ onDonate }: Props) {
    ...
    <div className="flex flex-col items-center gap-2" ref={panelRef}>
      ...
      >
        <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0d0f17] shadow-xl dark:shadow-black/40 p-5">
          ...
          {/* Custom amount input */}
          <div className="mb-3 flex items-center rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 overflow-hidden">
